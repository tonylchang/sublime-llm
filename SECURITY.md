...
- Storing keys in `sublime-llm.sublime-settings` is opt-in (`allow_secrets_in_settings_file`) and off by default; stray keys in that file are ignored at runtime with a warning.
